...
class EktpFormPage2 extends StatefulWidget {
  EktpFormPage2({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _EktpFormPage2State createState() => _EktpFormPage2State();
}

class _EktpFormPage2State extends State<EktpFormPage2> {
